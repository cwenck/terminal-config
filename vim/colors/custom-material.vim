hi clear
syntax reset
let g:colors_name = "custom-material"
if &background == "light"
...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#81dfea guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#36464e guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#ff4281 guibg=NONE
    hi Constant gui=NONE guifg=#808080 guibg=NONE
    hi Cursor gui=reverse guifg=NONE guibg=#36464e
    hi CursorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi CursorLine gui=NONE guifg=NONE guibg=#36464e
    hi CursorLineNr gui=NONE guifg=#707070 guibg=NONE
    hi DiffAdd gui=NONE guifg=NONE guibg=#4cae4f
    hi DiffChange gui=NONE guifg=NONE guibg=#1a1a1a
    hi DiffDelete gui=NONE guifg=NONE guibg=#e53734
    hi DiffText gui=NONE guifg=NONE guibg=#333333
    hi Directory gui=NONE guifg=#8fa3ae guibg=NONE
    hi Error gui=NONE guifg=NONE guibg=#f50056
    hi ErrorMsg gui=NONE guifg=NONE guibg=#e53734
    hi FoldColumn gui=NONE guifg=#616161 guibg=NONE
    hi Folded gui=NONE guifg=#707070 guibg=NONE
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=NONE guibg=#2094f3
    hi LineNr gui=NONE guifg=#616161 guibg=NONE
    hi MatchParen gui=NONE guifg=NONE guibg=#333333
    hi ModeMsg gui=NONE guifg=#00aeff guibg=NONE
    hi MoreMsg gui=NONE guifg=#ff4281 guibg=NONE
    hi NonText gui=NONE guifg=#616161 guibg=NONE
    hi Normal gui=NONE guifg=#ebedef guibg=#1d262a
    hi Number gui=NONE guifg=#9574cd guibg=NONE
    hi Pmenu gui=NONE guifg=#8fa3ae guibg=#36464e
    hi PmenuSbar gui=NONE guifg=#36464e guibg=#262626
    hi PmenuSel gui=NONE guifg=#ebedef guibg=#2094f3
    ...
    hi Special gui=NONE guifg=#00aeff guibg=NONE
    hi SpecialKey gui=NONE guifg=#616161 guibg=NONE
    hi SpellBad gui=undercurl guisp=NONE guifg=NONE guibg=#f50056
    hi SpellCap gui=undercurl guisp=NONE guifg=NONE guibg=NONE
    ...
    hi Statement gui=NONE guifg=#8bc34b guibg=NONE
    hi StatusLine gui=NONE guifg=#78909b guibg=#36464e
    hi StatusLineNC gui=NONE guifg=#707070 guibg=#262626
    hi StorageClass gui=NONE guifg=#ff4281 guibg=NONE
    hi String gui=NONE guifg=#ffb300 guibg=NONE
    hi TabLine gui=NONE guifg=#78909b guibg=#36464e
    hi TabLineFill gui=NONE guifg=NONE guibg=#36464f
    hi TabLineSel gui=NONE guifg=#ebecef guibg=#2094f3
    ...
    hi Visual gui=NONE guifg=NONE guibg=#36464e
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=NONE guibg=#e53734
    hi WildMenu gui=NONE guifg=NONE guibg=#2094f3
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE
    hi PreProc gui=NONE guifg=NONE guibg=NONE
endif
